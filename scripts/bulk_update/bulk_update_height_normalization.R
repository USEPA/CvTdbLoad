#' @title bulk_update_height_normalization
#' @description Utility function to perform bulk subject height normalization to all subject records.
...
#' @rdname bulk_update_height_normalization
#' @export 
