#' @title bulk_update_age_normalization
#' @description Utility function to perform bulk subject age normalization to all subject records.
...
#' @rdname bulk_update_age_normalization
#' @export 
