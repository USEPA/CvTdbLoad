...
|     CvTdb-QAPP               |     Quality Assurance Project Plan                                                                                                                       | .pdf      |
...
<!-- End of tabset -->
:::
i. Total Subjects changes dramatically between v1.1.0 and v2.0.0 due to an effort to move to create unique subject table entries per extraction document, rather than having documents share the same subject entry. This helped untangle and prevent cases where a document is QC'd and subject information is updated, causing subject information to be incorrect for other linked documents. Also, NTP documents were re-extracted to report on a per-subject basis, often having hundreds of entries.
...
-   \*\*Add description of data dictionary update decisions and why certain entries were updated or left blank.
